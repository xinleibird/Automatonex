...
Automaton_Tooltip.options = {
	...
	showPetHappiness = {
		...
		order = 27,
		get = function()
			return Automaton_Tooltip.db.profile.showPetHappiness
		end,
		set = function(v)
			Automaton_Tooltip.db.profile.showPetHappiness = v
		end,
	},
	showPetFood = {
		type = "toggle",
		...
		order = 28,
		get = function()
			return Automaton_Tooltip.db.profile.showPetFood
		end,
		set = function(v)
			Automaton_Tooltip.db.profile.showPetFood = v
		end,
	},
	showPetExp = {
		type = "toggle",
		...
		order = 29,
		get = function()
			return Automaton_Tooltip.db.profile.showPetExp
		end,
		set = function(v)
			Automaton_Tooltip.db.profile.showPetExp = v
		end,
	},
	header3 = {
		type = "header",
...
function Automaton_Tooltip:ShowPetInfo(unit)
	if not UnitExists(unit) or not UnitIsUnit(unit, "pet") then
		return
	end
